    ...
    : IRequestHandler<AdminBulkUnbanUsersCommand, BulkUsersOperationResponse>
{
    ...
    public AdminBulkUnbanUsersHandler(IUserModerationService users) => _users = users;

    public async Task<BulkUsersOperationResponse> Handle(AdminBulkUnbanUsersCommand cmd, CancellationToken ct)
    {
