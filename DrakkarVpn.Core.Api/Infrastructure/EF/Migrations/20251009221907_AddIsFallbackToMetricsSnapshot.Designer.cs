...
namespace DrakkarVpn.Core.Api.Infrastructure.EF.Migrations
{
    ...
    [Migration("20251009221907_AddIsFallbackToMetricsSnapshot")]
    partial class AddIsFallbackToMetricsSnapshot
    {
        /// <inheritdoc />
                    ...
                    b.OwnsOne("DrakkarVpn.Core.Api.Modules.Servers.Domain.VO.MetricsSnapshot", "Metrics", b1 =>
                        {
                            ...
                            b1.Property<bool>("IsFallBack")
                                .HasColumnType("boolean");

                            b1.Property<double>("PacketLossPercent")
                                .HasColumnType("double precision")
                                .HasColumnName("metrics_packet_loss_percent");
                            ...
                            b1.Property<double>("VpnLatencyMs")
                                .HasColumnType("double precision")
                                .HasColumnName("metrics_vpn_latency_ms");
